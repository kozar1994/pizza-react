      ...
      <div className="pizza-block__selector">
        <ul>
          {typesNames.map((type, index) => (
            <li
              key={type}
              onClick={() => toggleType(index, "pizza")}
              className={classNames({
                active: index === pizzaType,
                disablet: !types.includes(index)
              })}
            >
              {type}
            </li>
        ...
        <ul>
          {sizeNames && sizeNames.map((size, index) => (
            <li
              key={size}
              onClick={() => toggleType(index, "size")}
              className={classNames({
                active: index === sizeType
              })}
            >
              {size} см.
            </li>
